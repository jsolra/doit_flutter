...
import 'package:tabbar_listview/iosSub/cupertinoFirstPage.dart';
import 'package:tabbar_listview/iosSub/cupertinoSecondPage.dart';

class CupertinoMain extends StatefulWidget {
  CupertinoMain({Key? key}) : super(key: key);

  @override
  _CupertinoMainState createState() => _CupertinoMainState();
  // 동일한 코드
  // State<StatefulWidget> createState() {return _CupertinoMainState();}
}
